{
  ...
  "metadata": {
    "colab": {
      "name": "Classificação e Clusterização.R",
      "provenance": [],
      "authorship_tag": "ABX9TyOXx3dy7ADHOVXU072sjP0k",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/gizattos/Python/blob/master/Classifica%C3%A7%C3%A3o_e_Clusteriza%C3%A7%C3%A3o.R\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
